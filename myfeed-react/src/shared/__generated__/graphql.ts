...
export type AllPostsQuery = { __typename?: 'Query', posts: { __typename?: 'FindPostsPaginationResponse', data?: Array<{ __typename?: 'PostModel', createdAt: string, description: string, likesCount: number, isLiked: boolean, title: string, mediaUrl: string, id: string, author: { __typename?: 'UserModel', firstName?: string | null, lastName?: string | null, avatarUrl?: string | null } }> | null } };

export type FavouritePostsQueryVariables = Exact<{ [key: string]: never; }>;


export type FavouritePostsQuery = { __typename?: 'Query', favouritePosts: { __typename?: 'FindFavouritePostsPaginationResponse', data?: Array<{ __typename?: 'PostModel', createdAt: string, description: string, likesCount: number, isLiked: boolean, title: string, mediaUrl: string, id: string, author: { __typename?: 'UserModel', firstName?: string | null, lastName?: string | null, avatarUrl?: string | null } }> | null } };

export type MyPostsQueryVariables = Exact<{ [key: string]: never; }>;


export type MyPostsQuery = { __typename?: 'Query', myPosts: { __typename?: 'FindMyPostsPaginationResponse', data?: Array<{ __typename?: 'PostModel', createdAt: string, description: string, likesCount: number, isLiked: boolean, title: string, mediaUrl: string, id: string, author: { __typename?: 'UserModel', firstName?: string | null, lastName?: string | null, avatarUrl?: string | null } }> | null } };
